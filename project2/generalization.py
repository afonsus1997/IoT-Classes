...
test_data['Requests_mm'] = test_data['Requests'].rolling(10, win_type='triang').sum()
test_data['Load_mm'] = test_data['Load'].rolling(10, win_type='triang').sum()
...
#normal test
#====BEST RESULTS FOR NO_OVERSAMPLING
layersizes = (192, 209, 34)
cols = ['Requests', 'Requests2', 'Load', 'High_load', 'Requests_mm']


layersizes = (150,) #1
cols = ['Requests1', 'Load', 'High_requests', 'High_features', 'Requests_mm', 'Load_mm']

layersizes = (232,) #3
cols = ['Requests', 'Requests2', 'High_load', 'Requests_mm', 'Load_mm']

layersizes = (71, 150) #21
cols = ['Requests2', 'Load', 'High_requests', 'Requests_mm']

layersizes = (150,) #40
cols = ['Requests1', 'Requests2', 'Load', 'High_requests', 'High_features', 'Requests_mm', 'Load_mm']

layersizes = (34,) #62
cols = ['Requests', 'Requests1', 'Load', 'Requests_mm', 'Load_mm']


layersizes = (204, 194) #158
cols = ['Requests', 'Requests2', 'Load', 'High_requests', 'High_features', 'Requests_mm', 'Load_mm']
