...
x_test, (x_val), y_test, y_val = train_test_split(x_test, y_test, test_size=0.3, shuffle=False)
...
model.fit(x_train_splits, y_train_splits, epochs=200, verbose=0)
...
# for i in range(len(x_train_splits)):
y_train_splits_pred = model.predict(x_train_splits, verbose=0)
...
print("F-Measure:")
print(f1_score(y_train_splits, y_train_splits_pred, average=None))
...
print("F-Measure:")
print(f1_score(y_test_splits, y_test_splits_pred, average=None))
